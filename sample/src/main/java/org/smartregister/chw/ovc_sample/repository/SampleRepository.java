package org.smartregister.chw.ovc_sample.repository;
...
import org.smartregister.chw.ovc_sample.BuildConfig;
import org.smartregister.chw.ovc.OvcLibrary;
import org.smartregister.chw.ovc_sample.application.SampleApplication;
...
public class SampleRepository extends Repository {
    ...
    public void onCreate(SQLiteDatabase database) {
        ...
        OvcLibrary.getInstance().visitRepository().createTable(database);
        OvcLibrary.getInstance().visitDetailsRepository().createTable(database);

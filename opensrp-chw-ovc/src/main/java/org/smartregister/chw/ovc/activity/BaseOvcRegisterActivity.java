...
import org.smartregister.chw.ovc.interactor.BaseOvcRegisterInteractor;
import org.smartregister.chw.ovc.listener.OvcBottomNavigationListener;
import org.smartregister.chw.ovc.model.BaseOvcRegisterModel;
import org.smartregister.chw.ovc.presenter.BaseOvcRegisterPresenter;
...
public class BaseOvcRegisterActivity extends BaseRegisterActivity implements OvcRegisterContract.View {
    ...
    public void startFormActivity(String formName, String entityId, String metaData) {
        try {
            if (mBaseFragment instanceof BaseOvcRegisterFragment) {
    ...
    public void startFormActivity(JSONObject jsonForm) {
        Intent intent = new Intent(this, BaseOvcRegisterActivity.class);
    ...
    protected void registerBottomNavigation() {
        ...
        if (bottomNavigationView != null) {
            ...
            BottomNavigationListener familyBottomNavigationListener = new OvcBottomNavigationListener(this);
    ...
    protected void initializePresenter() {
        presenter = new BaseOvcRegisterPresenter(this, new BaseOvcRegisterModel(), new BaseOvcRegisterInteractor());
    }
    ...
    @Override
    public OvcRegisterContract.Presenter presenter() {
        return (OvcRegisterContract.Presenter) presenter;
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == Activity.RESULT_OK && requestCode == Constants.REQUEST_CODE_GET_JSON) {
            ...
            try {
                ...
                JSONArray fieldsOne = OvcJsonFormUtils.fields(form, Constants.STEP_ONE);
    ...
    public void startClientProcessing() {
        try {
            ...
            OvcUtil.getClientProcessorForJava().processClient(OvcUtil.getSyncHelper().getEvents(lastSyncDate, BaseRepository.TYPE_Unprocessed));

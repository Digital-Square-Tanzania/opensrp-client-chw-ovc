...
import org.smartregister.chw.ovc.fragment.BaseHomeVisitFragment;
 ...
 */
public class BaseOvcVisitAction {
    ...
    private BaseOvcVisitAction(Builder builder) throws ValidationException {
    ...
    public BaseOvcVisitAction.Status computedStatus() {
    ...
    public interface OvcVisitActionHelper {
         ...
         */
        void onPayloadReceived(BaseOvcVisitAction baseOvcVisitAction);
    }
    ...
    public static class Builder {
        ...
        public BaseOvcVisitAction build() throws ValidationException {
            return new BaseOvcVisitAction(this);
        }
    }

package org.smartregister.chw.ovc.provider;
...
public class OvcRegisterProvider implements RecyclerViewProvider<OvcRegisterProvider.RegisterViewHolder> {
    ...
    public OvcRegisterProvider(Context context, View.OnClickListener paginationClickListener, View.OnClickListener onClickListener, Set visibleColumns) {
    ...
    private String updateMemberGender(CommonPersonObjectClient commonPersonObjectClient) {
        ...
        return OvcUtil.getGenderTranslated(context, gender);
    ...
    private void populatePatientColumn(CommonPersonObjectClient pc, final RegisterViewHolder viewHolder) {
        try {
            ...
            viewHolder.patientColumn.setTag(R.id.VIEW_ID, BaseOvcRegisterFragment.CLICK_VIEW_NORMAL);

            viewHolder.dueButton.setTag(pc);
            viewHolder.dueButton.setTag(R.id.VIEW_ID, BaseOvcRegisterFragment.FOLLOW_UP_VISIT);

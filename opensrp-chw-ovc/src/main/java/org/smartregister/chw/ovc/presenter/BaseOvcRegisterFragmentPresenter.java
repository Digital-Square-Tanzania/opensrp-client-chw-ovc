...
public class BaseOvcRegisterFragmentPresenter implements OvcRegisterFragmentContract.Presenter {

    protected WeakReference<OvcRegisterFragmentContract.View> viewReference;
    ...
    public BaseOvcRegisterFragmentPresenter(OvcRegisterFragmentContract.View view, OvcRegisterFragmentContract.Model model, String viewConfigurationIdentifier) {
    ...
    protected OvcRegisterFragmentContract.View getView() {

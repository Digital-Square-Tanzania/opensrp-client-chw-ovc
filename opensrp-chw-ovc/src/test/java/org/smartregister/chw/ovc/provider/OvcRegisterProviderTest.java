...
public class OvcRegisterProviderTest {
    @Mock
    public CommonPersonObjectClient commonPersonObjectClient;
    @Mock
    public View.OnClickListener listener;
    @Mock
    public OvcRegisterProvider.RegisterViewHolder viewHolder;
    @Mock
    private OvcRegisterProvider testRegisterProvider;
    ...
    public void updateMemberGender() throws Exception {
        ...
        OvcRegisterProvider provider = new OvcRegisterProvider(activity, listener, listener, null);

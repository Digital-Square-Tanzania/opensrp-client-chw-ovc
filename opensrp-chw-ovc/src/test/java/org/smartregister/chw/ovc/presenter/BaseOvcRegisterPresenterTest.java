...
@PrepareForTest(BaseOvcRegisterPresenter.class)
public class BaseOvcRegisterPresenterTest {
    @Mock
    protected BaseOvcRegisterPresenter baseOvcRegisterPresenter;

    @Mock
    protected OvcRegisterContract.Interactor interactor;
    @Mock
    protected OvcRegisterContract.Model model;
    @Mock
    protected OvcRegisterContract.View baseView;
    private BaseOvcRegisterPresenter presenter;

    @Before
    public void setUp() {
        MockitoAnnotations.initMocks(this);
        presenter = new BaseOvcRegisterPresenter(baseView, model, interactor);
    }
    ...
    public void getViewWhenViewIsNull() throws Exception {
        Assert.assertNull(Whitebox.invokeMethod(baseOvcRegisterPresenter, "getView"));
    }

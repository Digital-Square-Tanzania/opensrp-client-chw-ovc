...
public class BaseOvcProfileActivityTest {
    @Mock
    public BaseOvcProfileActivity baseTestProfileActivity;

    @Mock
    public OvcProfileContract.Presenter profilePresenter;
    ...
    public void formatTime() {
        BaseOvcProfileActivity activity = new BaseOvcProfileActivity();
        try {
    ...
    public void onClickBackPressed() {
        baseTestProfileActivity = Mockito.spy(new BaseOvcProfileActivity());
